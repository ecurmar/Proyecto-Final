sap.ui.define([
    "logaligroup/proyectofinal/controller/Base.controller",
    "sap/ui/model/Filter",
    ...
    function (Base, Filter, FilterOperator) {
        ...
        function onInit() {
            ...
            var oRouter = this.getOwnerComponent().getRouter().getRoute("ViewEmployees")
        ...
        function employeePromoteSave() {
            ...
            var body = {
                Amount: promotedEmployee.getData().Ammount,
        ...
        var Main = Base.extend("logaligroup.proyectofinal.controller.ViewEmployees", {});
